...
{
    [Test]
    public void GenerateKeyPair_ReturnsPublicAndPrivateKeys()
    {
    ...
    [Test]
    public void GenerateRootCertificate_SignsVerifiableCertificate()
    {
        _ = Random.Shared.NextInt64();
        var rootCertificateIdBytes = Convert.FromHexString("CACACACA00000001");
        ...
        Assert.That(rootCertificate.GetEncoded(), Is.Not.Empty);
    }

    [Test]
    public void GenerateRootCertificate_MatchesExpectedCertificateVersion()
    {
        ...
        PemReader publicPemReader = new(publicKeyReader);
    ...
    [Test]
    public void ParseNodeOperationalCertificate_ReturnsVersionThreeCertificate()
    {
        TextReader publicKeyReader = new StringReader($"-----BEGIN CERTIFICATE-----" +
...
"-----END CERTIFICATE-----");
        ...
        {
            Assert.That(exampleRootCertificate!.Version, Is.EqualTo(3));
            Assert.That(exampleRootCertificate.GetEncoded(), Is.Not.Empty);
        }
    }
}
