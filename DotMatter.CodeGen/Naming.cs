...
static class Naming
{
        ...
        bool isArray, string? entryType, HashSet<string>? localTypes = null)
    {
        ...
        string baseType = matterType.ToLowerInvariant() switch
        {
            ...
            "int8u" or "uint8" or "enum8" or "percent" or "action-id" or "action_id"
                or "fabric-idx" or "fabric_idx" or "status" => "byte",
            "int8s" or "int8" => "sbyte",
            "int16u" or "uint16" or "enum16" or "percent100ths" or "vendor-id"
            ...
            "int32u" or "uint32" or "cluster-id" or "cluster_id" or "attrib-id"
            ...
            "int32s" or "int32" => "int",
            "int64u" or "uint64" or "node-id" or "node_id" or "fabric-id"
            ...
            "int64s" or "int64" or "money" or "power_mva" => "long",
