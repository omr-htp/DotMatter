...
/// <summary>Commissioning parameters parsed from a Matter manual or QR pairing code.</summary>
public sealed record PairingCode(int Discriminator, uint Passcode, bool IsShort);
...
public static class PairingCodeParser
{
    ...
    /// Returns parsed commissioning parameters, or null if invalid.
    /// Manual codes contain a 4-bit SHORT discriminator (top 4 bits of the 12-bit long discriminator).
    /// </summary>
    public static PairingCode? ParseManualCode(string code)
    {
        ...
        return new PairingCode(shortDiscriminator, passcode, true);
    }
    ...
    /// </summary>
    public static PairingCode? ParseQrCode(string payload)
    {
        ...
        return new PairingCode(discriminator, passcode, false);
    }
