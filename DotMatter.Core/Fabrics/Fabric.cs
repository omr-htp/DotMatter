...
internal sealed record FabricOperationalCertificate(X509Certificate Certificate, ECDsa KeyPair);
...
public class Fabric
{
    ...
    internal static FabricOperationalCertificate GenerateNOC(
        ECDsa rootKeyPair,
        ...
        BigInteger? nodeId = null)
    {
        ...
        return new FabricOperationalCertificate(noc, keyPair);
    }
