...
public class FabricManager(IFabricStorageProvider storageProvider)
{
    ...
    public async Task<Fabric> GetAsync(string fabricName)
    {
        ...
        else
        {
            ...
            var (noc, nocKeyPair) = Fabric.GenerateNOC(rootKeyPair, rootKeyIdentifier, fabricId, rootCertificateId);
            ...
            fabric = new Fabric()
            {
                ...
                OperationalECDiffieHellman = ECDiffieHellman.Create(nocKeyPair.ExportParameters(true)),
