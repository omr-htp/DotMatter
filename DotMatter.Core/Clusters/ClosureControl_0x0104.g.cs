...
public class ClosureControlCluster : ClusterBase
{
    ...
    private static OverallCurrentStateStruct ReadOverallCurrentStateStruct(MatterTLV tlv)
        => ReadOverallCurrentStateStruct(tlv, null);

    private static OverallCurrentStateStruct ReadOverallCurrentStateStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static OverallTargetStateStruct ReadOverallTargetStateStruct(MatterTLV tlv)
        => ReadOverallTargetStateStruct(tlv, null);

    private static OverallTargetStateStruct ReadOverallTargetStateStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<InvokeResponse> CalibrateAsync(CancellationToken ct = default, ushort timedTimeoutMs = 5000)
        => InvokeTimedCommandAsync(0x0002, timedTimeoutMs: timedTimeoutMs, ct: ct);
    ...
    public Task<OverallCurrentStateStruct?> ReadOverallCurrentStateAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0003, raw => ReadOverallCurrentStateStruct(raw, 2), ct);

    /// <summary>Read OverallTargetState attribute (0x0004).</summary>
    public Task<OverallTargetStateStruct?> ReadOverallTargetStateAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0004, raw => ReadOverallTargetStateStruct(raw, 2), ct);
