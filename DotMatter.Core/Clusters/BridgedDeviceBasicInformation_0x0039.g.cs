...
// XML: bridged-device-basic-information-cluster.xml
// Cluster: Bridged Device Basic Information (0x0039)
...
/// <summary>Bridged Device Basic Information (0x0039, rev 5)</summary>
public class BridgedDeviceBasicInformationCluster : ClusterBase
{
    ...
    /// <summary>Creates a new <see cref="BridgedDeviceBasicInformationCluster"/> bound to the given session and endpoint.</summary>
    public BridgedDeviceBasicInformationCluster(ISession session, ushort endpointId = 1)
    ...
    {
        /// <summary>Support bridged ICDs.</summary>
        BridgedICDSupport = 1u << 20,
    }
    ...
    {
        /// <summary>KeepActive (0x0080).</summary>
        public const uint KeepActive = 0x0080;
    }
    ...
    /// <summary>Send KeepActive command (0x0080).</summary>
    public Task<InvokeResponse> KeepActiveAsync(
        uint stayActiveDuration,
        uint timeoutMs,
        CancellationToken ct = default)
        => InvokeCommandAsync(0x0080, tlv =>
        {
            tlv.AddUInt32(0, stayActiveDuration);
            tlv.AddUInt32(1, timeoutMs);
        }, ct);
