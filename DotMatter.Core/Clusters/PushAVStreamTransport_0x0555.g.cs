...
public class PushAVStreamTransportCluster : ClusterBase
{
    ...
    private static CMAFContainerOptionsStruct ReadCMAFContainerOptionsStruct(MatterTLV tlv)
        => ReadCMAFContainerOptionsStruct(tlv, null);

    private static CMAFContainerOptionsStruct ReadCMAFContainerOptionsStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static ContainerOptionsStruct ReadContainerOptionsStruct(MatterTLV tlv)
        => ReadContainerOptionsStruct(tlv, null);

    private static ContainerOptionsStruct ReadContainerOptionsStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static SupportedFormatStruct ReadSupportedFormatStruct(MatterTLV tlv)
        => ReadSupportedFormatStruct(tlv, null);

    private static SupportedFormatStruct ReadSupportedFormatStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TransportConfigurationStruct ReadTransportConfigurationStruct(MatterTLV tlv)
        => ReadTransportConfigurationStruct(tlv, null);

    private static TransportConfigurationStruct ReadTransportConfigurationStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TransportMotionTriggerTimeControlStruct ReadTransportMotionTriggerTimeControlStruct(MatterTLV tlv)
        => ReadTransportMotionTriggerTimeControlStruct(tlv, null);

    private static TransportMotionTriggerTimeControlStruct ReadTransportMotionTriggerTimeControlStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TransportOptionsStruct ReadTransportOptionsStruct(MatterTLV tlv)
        => ReadTransportOptionsStruct(tlv, null);

    private static TransportOptionsStruct ReadTransportOptionsStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TransportTriggerOptionsStruct ReadTransportTriggerOptionsStruct(MatterTLV tlv)
        => ReadTransportTriggerOptionsStruct(tlv, null);

    private static TransportTriggerOptionsStruct ReadTransportTriggerOptionsStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TransportZoneOptionsStruct ReadTransportZoneOptionsStruct(MatterTLV tlv)
        => ReadTransportZoneOptionsStruct(tlv, null);

    private static TransportZoneOptionsStruct ReadTransportZoneOptionsStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<SupportedFormatStruct[]?> ReadSupportedFormatsAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0000, ReadSupportedFormatStruct, ct);
    ...
    public Task<TransportConfigurationStruct[]?> ReadCurrentConnectionsAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0001, ReadTransportConfigurationStruct, ct);
