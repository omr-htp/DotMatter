...
public class DeviceEnergyManagementCluster : ClusterBase
{
    ...
    private static CostStruct ReadCostStruct(MatterTLV tlv)
        => ReadCostStruct(tlv, null);

    private static CostStruct ReadCostStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static PowerAdjustCapabilityStruct ReadPowerAdjustCapabilityStruct(MatterTLV tlv)
        => ReadPowerAdjustCapabilityStruct(tlv, null);

    private static PowerAdjustCapabilityStruct ReadPowerAdjustCapabilityStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static PowerAdjustStruct ReadPowerAdjustStruct(MatterTLV tlv)
        => ReadPowerAdjustStruct(tlv, null);

    private static PowerAdjustStruct ReadPowerAdjustStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static ForecastStruct ReadForecastStruct(MatterTLV tlv)
        => ReadForecastStruct(tlv, null);

    private static ForecastStruct ReadForecastStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static SlotStruct ReadSlotStruct(MatterTLV tlv)
        => ReadSlotStruct(tlv, null);

    private static SlotStruct ReadSlotStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static SlotAdjustmentStruct ReadSlotAdjustmentStruct(MatterTLV tlv)
        => ReadSlotAdjustmentStruct(tlv, null);

    private static SlotAdjustmentStruct ReadSlotAdjustmentStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static ConstraintsStruct ReadConstraintsStruct(MatterTLV tlv)
        => ReadConstraintsStruct(tlv, null);

    private static ConstraintsStruct ReadConstraintsStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<PowerAdjustCapabilityStruct?> ReadPowerAdjustmentCapabilityAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0005, raw => ReadPowerAdjustCapabilityStruct(raw, 2), ct);

    /// <summary>Read Forecast attribute (0x0006).</summary>
    public Task<ForecastStruct?> ReadForecastAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0006, raw => ReadForecastStruct(raw, 2), ct);
