...
public class CommodityPriceCluster : ClusterBase
{
    ...
    private static CommodityPriceComponentStruct ReadCommodityPriceComponentStruct(MatterTLV tlv)
        => ReadCommodityPriceComponentStruct(tlv, null);

    private static CommodityPriceComponentStruct ReadCommodityPriceComponentStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static CommodityPriceStruct ReadCommodityPriceStruct(MatterTLV tlv)
        => ReadCommodityPriceStruct(tlv, null);

    private static CommodityPriceStruct ReadCommodityPriceStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<CurrencyStruct?> ReadCurrencyAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0001, raw => ReadCurrencyStruct(raw, 2), ct);

    /// <summary>Read CurrentPrice attribute (0x0002).</summary>
    public Task<CommodityPriceStruct?> ReadCurrentPriceAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0002, raw => ReadCommodityPriceStruct(raw, 2), ct);
    ...
    public Task<CommodityPriceStruct[]?> ReadPriceForecastAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0003, ReadCommodityPriceStruct, ct);
