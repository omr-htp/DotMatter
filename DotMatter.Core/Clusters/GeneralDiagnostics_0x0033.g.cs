...
public class GeneralDiagnosticsCluster : ClusterBase
{
    ...
    private static NetworkInterface ReadNetworkInterface(MatterTLV tlv)
        => ReadNetworkInterface(tlv, null);

    private static NetworkInterface ReadNetworkInterface(MatterTLV tlv, int? tag)
    {
    ...
    public Task<NetworkInterface[]?> ReadNetworkInterfacesAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0000, ReadNetworkInterface, ct);
