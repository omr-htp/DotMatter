...
public class ChimeCluster : ClusterBase
{
    ...
    private static ChimeSoundStruct ReadChimeSoundStruct(MatterTLV tlv)
        => ReadChimeSoundStruct(tlv, null);

    private static ChimeSoundStruct ReadChimeSoundStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<ChimeSoundStruct[]?> ReadInstalledChimeSoundsAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0000, ReadChimeSoundStruct, ct);
