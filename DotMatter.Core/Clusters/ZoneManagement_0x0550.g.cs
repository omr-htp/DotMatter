...
public class ZoneManagementCluster : ClusterBase
{
    ...
    private static TwoDCartesianVertexStruct ReadTwoDCartesianVertexStruct(MatterTLV tlv)
        => ReadTwoDCartesianVertexStruct(tlv, null);

    private static TwoDCartesianVertexStruct ReadTwoDCartesianVertexStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static TwoDCartesianZoneStruct ReadTwoDCartesianZoneStruct(MatterTLV tlv)
        => ReadTwoDCartesianZoneStruct(tlv, null);

    private static TwoDCartesianZoneStruct ReadTwoDCartesianZoneStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static ZoneInformationStruct ReadZoneInformationStruct(MatterTLV tlv)
        => ReadZoneInformationStruct(tlv, null);

    private static ZoneInformationStruct ReadZoneInformationStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static ZoneTriggerControlStruct ReadZoneTriggerControlStruct(MatterTLV tlv)
        => ReadZoneTriggerControlStruct(tlv, null);

    private static ZoneTriggerControlStruct ReadZoneTriggerControlStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<ZoneInformationStruct[]?> ReadZonesAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0002, ReadZoneInformationStruct, ct);
    ...
    public Task<ZoneTriggerControlStruct[]?> ReadTriggersAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0003, ReadZoneTriggerControlStruct, ct);
    ...
    public Task<TwoDCartesianVertexStruct?> ReadTwoDCartesianMaxAsync(CancellationToken ct = default)
        => ReadStructAttributeAsync(0x0006, raw => ReadTwoDCartesianVertexStruct(raw, 2), ct);
