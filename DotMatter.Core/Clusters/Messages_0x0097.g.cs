...
public class MessagesCluster : ClusterBase
{
    ...
    private static MessageStruct ReadMessageStruct(MatterTLV tlv)
        => ReadMessageStruct(tlv, null);

    private static MessageStruct ReadMessageStruct(MatterTLV tlv, int? tag)
    {
    ...
    private static MessageResponseOptionStruct ReadMessageResponseOptionStruct(MatterTLV tlv)
        => ReadMessageResponseOptionStruct(tlv, null);

    private static MessageResponseOptionStruct ReadMessageResponseOptionStruct(MatterTLV tlv, int? tag)
    {
    ...
    public Task<MessageStruct[]?> ReadMessagesAsync(CancellationToken ct = default)
        => ReadArrayAttributeAsync(0x0000, ReadMessageStruct, ct);
