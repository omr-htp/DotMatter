...
public class AccountLoginCluster : ClusterBase
{
    ...
    public Task<InvokeResponse> GetSetupPINAsync(
        ...
        => InvokeTimedCommandAsync(0x0000, tlv => { tlv.AddUTF8String(0, tempAccountIdentifier); }, timedTimeoutMs: timedTimeoutMs, ct: ct);
    ...
    public Task<InvokeResponse> LogoutAsync(
        ...
        CancellationToken ct = default,
        ushort timedTimeoutMs = 5000)
        => InvokeTimedCommandAsync(0x0003, tlv => { if (node != null) tlv.AddUInt64(0, node.Value); }, timedTimeoutMs: timedTimeoutMs, ct: ct);
