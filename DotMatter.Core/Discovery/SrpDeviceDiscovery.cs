...
public partial class SrpDeviceDiscovery
{
    ...
    /// <returns>Tuple of (IPAddress, port)</returns>
    public static async Task<(IPAddress Address, ushort Port)> DiscoverAsync(
        ...
        SrpDiscoveryOptions? options = null)
    {
        ...
        if (fallbackIp != null)
        {
            ...
            return (fallbackIp, effectivePort);
        }
    ...
    /// </summary>
    public static async Task<(IPAddress Address, ushort Port, string ServiceName)?> DiscoverAnyAsync(
        string compressedFabricId)
    {
        try
        {
            ...
            if (addrPort.HasValue)
            {
                return (addrPort.Value.Address, addrPort.Value.Port, serviceName);
            }
        }
        catch (Exception ex)
        {
    ...
    private static async Task<(IPAddress Address, ushort Port)?> TrySrpServerAsync(
    ...
    private static (IPAddress Address, ushort Port)? ParseSrpEntry(string output, string serviceName)
    {
    ...
    private static async Task<(IPAddress Address, ushort Port)?> TryDnsBrowseAsync(
        string compressedFabricId, string nodeOperationalId)
    {
        try
        {
