...
/// </summary>
public abstract class DnsObject : ICloneable
{
    /// <summary>
    ...
    /// </param>
    public DnsObject Read(byte[] buffer)
    {
    ...
    /// </param>
    public DnsObject Read(byte[] buffer, int offset, int count)
    {
    ...
    ///   The source for the DNS object.
    /// </param>
    public DnsObject Read(Stream stream)
    {
        return Read(new WireReader(stream));
    }

    /// <inheritdoc />
    public abstract DnsObject Read(WireReader reader);
