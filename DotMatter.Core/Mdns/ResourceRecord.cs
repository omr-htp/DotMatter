...
public class ResourceRecord : DnsObject
{
    ...
    ///   Defaults to 1 day.
    /// </value>
    public static TimeSpan DefaultTTL { get; set; } = TimeSpan.FromDays(1);
    ...
    /// </remarks>
    public static TimeSpan DefaultHostTTL { get; set; } = TimeSpan.FromDays(1);
    ...
    /// <inheritdoc />
    public override DnsObject Read(WireReader reader)
    {
