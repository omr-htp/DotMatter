...
/// </param>
public class WireWriter(Stream stream)
{
    ...
    private readonly Dictionary<string, int> _pointers = [];
    ...
    {
        var seconds = (value.ToUniversalTime() - _unixEpoch).TotalSeconds;
