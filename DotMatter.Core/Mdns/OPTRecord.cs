...
public class OPTRecord : ResourceRecord
{
    ...
    public byte Opcode8
    {
        get
        {
            return (byte)(((TTL.Ticks / TimeSpan.TicksPerSecond) >> 24) & 0xff);
        }
        set
        {
    ...
    public byte Version
    {
        get
        {
            return (byte)(((TTL.Ticks / TimeSpan.TicksPerSecond) >> 16) & 0xff);
        }
        set
        {
            TTL = TimeSpan.FromTicks(
    ...
    public bool DO
    {
        get
        {
            return (TTL.Ticks / TimeSpan.TicksPerSecond) == 0x8000L;
        }
        set
        {
            TTL = TimeSpan.FromTicks(
