...
public class DeviceInfo
{
    ...
    public ColorControlCluster.ColorCapabilitiesBitmap ColorCapabilities
    {
        get; set;
    }
    ...
    public Dictionary<ushort, List<uint>>? Endpoints
    {
        get; set;
    }
